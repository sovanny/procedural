export const fragmentShader = `
  ...
  void main()	{
    ...
    vec3 snakeColor = vec3(1.0, 0.0, 0.0) * step(length(snakePosition - vec2(x, y)), snakeRadius);
    vec3 candyColor = vec3(0.0, 1.0, 1.0) * step(length(candyPosition - vec2(x, y)), candyRadius);
